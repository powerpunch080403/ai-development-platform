...
현재 저장소는 **Project / Repository Registration + Git Status 단계**다. 로컬 인증 위에 Project와 여러 ProjectRepository 등록, default/current branch와 commit 조회, dirty check를 구현했다. Local Worker, CLI Adapter와 Remote Test Runner는 아직 구현하지 않았다.
