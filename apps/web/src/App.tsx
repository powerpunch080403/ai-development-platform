...
function WorkPanel({ projectId, repositories }: { projectId: string; repositories: ProjectRepositoryDto[] }) {
  ...
  return <section className="panel"><h2>Work / Tasks / Workers</h2><p className="muted">This MVP does not run real AI workers yet. Use Mock Worker or Manual Worker to validate the local execution pipeline.</p>
